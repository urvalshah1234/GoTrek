    ...
    <div className="layout-container">
      ...
      <div className="activity-section">
        ...
        <div className="activity-info">
          ...
          <p>
            Embark on the ultimate adventure with a bike trip to Ladakh, one of
            the most sought-after journeys for thrill-seekers and nature lovers
            alike. Known as the "Land of High Passes," Ladakh offers a unique
            blend of stark landscapes, majestic mountains, and serene
            monasteries, making it a biker's paradise. Riding through Ladakh is
            more than just a trip; it's an experience that challenges both your
            riding skills and your spirit of adventure. The journey typically
            starts from Manali or Srinagar, taking you through some of the most
            breathtaking and challenging terrains in the world.
          </p>
      ...
      <div className="activity-section">
        ...
        <div className="activity-info">
          ...
          <p>
            ...
            experience. The jump is conducted from a fixed platform on a cliff,
            83 meters above the ground, at a location known as Mohan Chatti.
            Operated by trained professionals, the bungee jump in Rishikesh is
            known for its safety standards and breathtaking views of the
            surrounding Shivalik hills and the Ganges River. It's an
      ...
      <div className="activity-section">
        ...
        <div className="activity-info">
          ...
          <p>
            Wildlife jungle safaris offer an immersive adventure into the heart
            of nature, where you can observe diverse wildlife in their natural
            habitat. Embark on guided tours through lush forests and dense
            jungles, where you might encounter majestic animals such as tigers,
            elephants, leopards, and various bird species. These safaris provide
            a unique opportunity to experience the thrill of wildlife viewing
            while contributing to conservation efforts. Ideal for nature
            enthusiasts, the experience combines excitement with the serene
      ...
      <h5 style={{ textAlign: "center", color: "orange" }}>
        You can only book these all by visiting that place
      </h5>
      <Footer />
    </div>
  );
