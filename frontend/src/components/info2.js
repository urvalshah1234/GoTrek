    ...
    <div className="info2-container">
      ...
      <div className="info2-sections">
        <div className="info2-section" data-aos="fade-up" data-aos-delay="200">
          ...
          <p>
            Hamta Pass is a high-altitude trek in the Kullu region of Himachal
            Pradesh. This trek offers a dramatic landscape shift from the lush
            green valleys of Kullu to the barren landscape of Lahaul. The trek
            is known for its beautiful campsites, alpine meadows, and panoramic
        ...
        <div className="info2-section" data-aos="fade-up" data-aos-delay="300">
          ...
          <p>
            The Triund Trek is a short, scenic trek that takes you to the Triund
            Hill, which offers stunning views of the Dhauladhar range. It's a
            perfect trek for beginners, with its relatively easy trail and
            rewarding views of the snow-capped peaks and the Kangra Valley
            below.
          </p>
        </div>
        <div className="info2-section" data-aos="fade-up" data-aos-delay="400">
          ...
          <p>
            The Kasol-Sar Pass trek is an exhilarating adventure that begins in
            the picturesque village of Kasol. The trek takes you through dense
            forests, lush meadows, and across the Sar Pass, which offers
            breathtaking views of the surrounding peaks. This trek is perfect
        ...
        <div className="info2-section" data-aos="fade-up" data-aos-delay="500">
          ...
          <p>
            Bhrigu Lake is a high-altitude glacial lake located near Manali. The
            trek to Bhrigu Lake is known for its lush green meadows, which
            resemble the alpine meadows of Switzerland. The lake itself is
            steeped in mythology, believed to be the meditation site of the sage
            Bhrigu.
          </p>
        </div>
      </div>
